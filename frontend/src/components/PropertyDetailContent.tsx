...
const SECTION_CRUMB: Record<ListingType, Crumb> = {
  SALE: { label: 'Buy', href: '/buy' },
  RENT: { label: 'Rent', href: '/rent' },
  SHORTLET: { label: 'Shortlet', href: '/shortlet' },
  INVESTMENT: { label: 'Invest', href: '/invest' },
};
    ...
    <div className="bg-white min-h-screen pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Breadcrumbs
          items={[
            { label: 'Home', href: '/' },
            SECTION_CRUMB[property.type as ListingType] ?? { label: 'Buy', href: '/buy' },
