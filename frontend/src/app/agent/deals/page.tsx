...
function AgentDeals() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setDeals(all.filter((d) => d.agent.userId === appUser?.id));
    } catch {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="flex items-center gap-3 mb-10">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-secondary">Deals</h1>
          <p className="text-gray-400 font-bold text-sm">Payment terms proposed by or to your clients</p>
        </div>
      </div>
